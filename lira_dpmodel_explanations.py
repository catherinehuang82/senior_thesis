...
#             variances_dir = f'lira/norms_l1_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
#         else:
#             variances_dir = f'lira/norms_l1_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'

#         if os.path.exists(f'{variances_dir}/{args.experiment_no}.csv'):
#             print(f"The explanation L1 norm file already exists. Terminating job.")
#             return None
    ...
    try:
        if not args.dry_run:
            debug_dir = f'lira/debug_{args.cifar_data}_{args.total_data_examples}'
    ...
    model = timm.create_model(args.model, num_classes=int(args.cifar_data[5:]))
    ...
    for i, (x, y) in tqdm(enumerate(combinedset)):
        ...
        if args.explanation_type == 'gs':
            ...
            # Apply the blur transformation to your image tensor
            blurred_image = gaussian_blur(x, kernel_size=25, sigma=(1.0,2.5))
            blurred_image = torch.unsqueeze(blurred_image, dim=0)
            baseline = blurred_image.float()
#             baseline = torch.zeros(inp.size())
...
#             print(f'attributions shape: {np.shape(attributions)}') # torch.Size([1, 3, 224, 224]
    ...
    if not args.dry_run:
        ...
        if 'nonDP' not in args.clipping_mode:
            variances_dir = f'lira/variances_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_l1_dir = f'lira/norms_l1_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_l2_dir = f'lira/norms_l2_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            deltas_dir = f'lira/deltas_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            attributions_dir = f'lira/attributions_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            preds_dir = f'lira/preds_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_eps={args.epsilon}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
        else:
            variances_dir = f'lira/variances_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_l1_dir = f'lira/norms_l1_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            norms_l2_dir = f'lira/norms_l2_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            deltas_dir = f'lira/deltas_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            attributions_dir = f'lira/attributions_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
            preds_dir = f'lira/preds_{args.cifar_data}_{args.total_data_examples}/model={args.model}_mode={args.clipping_mode}_type={args.explanation_type}_nsamples={args.nsamples}_epochs={args.epochs}'
...
#         if args.experiment_no <= 4:
        ...
        if args.experiment_no <= 4 and not os.path.exists(f'{attributions_dir}/channel3/{args.experiment_no}.csv'):
#         if args.experiment_no <= 4:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='beit_base_patch16_224.in22k_ft_in22k_in1k', type=str) # try: resnet18
