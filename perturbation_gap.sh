#!/bin/bash
#SBATCH -J gap_TEST_cif100 # A single job name for the array
...
conda run -n cnn python3 perturbation_gap.py --data $1 --epochs $2 --epsilon $3 --clipping_mode $4 --model $5 --explanation_type $6 --sigma $7 --k $8 --m $9